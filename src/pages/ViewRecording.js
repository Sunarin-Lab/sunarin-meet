...
export function ViewRecording() {
  ...
  return (
    <div>
      <h1>View Recording {params.recordingID}</h1>
      <video
        src={"http://localhost:8080/recordings/" + params.recordingID + ".mp4"}
        controls={true}
        width="1100px"
        width="700px"
      ...
      >
        <track
          ...
          kind="subtitles"
          srcLang="en"
          src={"http://localhost:8080/recordings/" + params.recordingID + ".srt"}
          default
        />
      </video>
    </div>
